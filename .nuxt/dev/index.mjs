...
import destr, { destr as destr$1 } from 'file:///Users/manlongfeng/Documents/trae_projects/grid_maker/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/manlongfeng/Documents/trae_projects/grid_maker/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/manlongfeng/Documents/trae_projects/grid_maker/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/manlongfeng/Documents/trae_projects/grid_maker/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, defineDriver, prefixStorage } from 'file:///Users/manlongfeng/Documents/trae_projects/grid_maker/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/manlongfeng/Documents/trae_projects/grid_maker/node_modules/unstorage/drivers/fs.mjs';
import fsDriver from 'file:///Users/manlongfeng/Documents/trae_projects/grid_maker/node_modules/unstorage/drivers/fs-lite.mjs';
import lruCache from 'file:///Users/manlongfeng/Documents/trae_projects/grid_maker/node_modules/unstorage/drivers/lru-cache.mjs';
import { digest } from 'file:///Users/manlongfeng/Documents/trae_projects/grid_maker/node_modules/nitropack/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/manlongfeng/Documents/trae_projects/grid_maker/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/manlongfeng/Documents/trae_projects/grid_maker/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/manlongfeng/Documents/trae_projects/grid_maker/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/manlongfeng/Documents/trae_projects/grid_maker/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/manlongfeng/Documents/trae_projects/grid_maker/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/manlongfeng/Documents/trae_projects/grid_maker/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/manlongfeng/Documents/trae_projects/grid_maker/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/manlongfeng/Documents/trae_projects/grid_maker/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/manlongfeng/Documents/trae_projects/grid_maker/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/manlongfeng/Documents/trae_projects/grid_maker/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/manlongfeng/Documents/trae_projects/grid_maker/node_modules/errx/dist/index.js';
import { isVNode, isRef, toValue } from 'file:///Users/manlongfeng/Documents/trae_projects/grid_maker/node_modules/vue/index.mjs';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file:///Users/manlongfeng/Documents/trae_projects/grid_maker/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///Users/manlongfeng/Documents/trae_projects/grid_maker/node_modules/pathe/dist/index.mjs';
import { hash as hash$1 } from 'file:///Users/manlongfeng/Documents/trae_projects/grid_maker/node_modules/nuxt/node_modules/ohash/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/manlongfeng/Documents/trae_projects/grid_maker/node_modules/unhead/dist/server.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/manlongfeng/Documents/trae_projects/grid_maker/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///Users/manlongfeng/Documents/trae_projects/grid_maker/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/manlongfeng/Documents/trae_projects/grid_maker/server/assets"}];
...
const _47Users_47manlongfeng_47Documents_47trae_projects_47grid_maker_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js = defineDriver(
  /**
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/manlongfeng/Documents/trae_projects/grid_maker","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/manlongfeng/Documents/trae_projects/grid_maker/server","watchOptions":{"ignored":[null]}}));
storage.mount('cache:nuxt:payload', _47Users_47manlongfeng_47Documents_47trae_projects_47grid_maker_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js({"driver":"/Users/manlongfeng/Documents/trae_projects/grid_maker/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js","base":"/Users/manlongfeng/Documents/trae_projects/grid_maker/.nuxt/cache/nuxt/payload"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/manlongfeng/Documents/trae_projects/grid_maker/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/manlongfeng/Documents/trae_projects/grid_maker/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/manlongfeng/Documents/trae_projects/grid_maker/.data/kv"}));
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"The ultimate Grid Maker for beginners. Create professional artwork with zero drawing skills. Completely free, no sign-up needed. Upload your photo now!"},{"name":"_foundr","content":"b48d6118930e9d6b333e00122fd53cf3"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"},{"rel":"icon","type":"image/png","href":"/favicon.png"}],"style":[],"script":[{"async":true,"src":"https://www.googletagmanager.com/gtag/js?id=G-G9S51Q6KQZ"},{"innerHTML":"\n            window.dataLayer = window.dataLayer || [];\n            function gtag(){dataLayer.push(arguments);}\n            gtag('js', new Date());\n            gtag('config', 'G-G9S51Q6KQZ');\n          "}],"noscript":[],"title":"Free Online Photo Grid Maker — No Design Skills Needed"};
...
const _5YzLjxqBztQUIOcbLoa2S5o11d0zPMkNghJoxEfDWm0 = (nitroApp) => {
...
const _ayAhxF = eventHandler((event) => {
