...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div><div class="footer-copyright"><p>\xA9 ${ssrInterpolate(year.value)} ${ssrInterpolate(__props.company)}. All rights reserved.</p></div>`);
...
//# sourceMappingURL=AppFooter-kkN9JGJC.mjs.map
